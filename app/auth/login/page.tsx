      ...
      >
        ...
        >
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 5, maxWidth: 380 }}>
            Continue your DevOps journey. Pick up right where you left off with your courses, labs, and learning paths.
          </Typography>

          {[
            { emoji: '🐧', text: 'Linux & System Administration' },
            { emoji: '🐳', text: 'Docker & Kubernetes' },
            { emoji: '☁️', text: 'AWS & Cloud Infrastructure' },
            { emoji: '🔄', text: 'CI/CD & GitOps Pipelines' },
          ].map(item => (
            <Box key={item.text} sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 1.5 }}>
              <Box sx={{ fontSize: '1.25rem' }}>{item.emoji}</Box>
        ...
        >
          ...
          >
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 4 }}>
              ...
              <Box component={NextLink} href="/auth/sign-up" sx={{ color: 'primary.main', fontWeight: 600, textDecoration: 'none', '&:hover': { textDecoration: 'underline' } }}>
                Sign up free
              </Box>
            </Typography>
            ...
            <Box component="form" onSubmit={handleLogin} sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: -1 }}>
                <Box
                  ...
                  sx={{ fontSize: '0.8rem', color: 'text.secondary', textDecoration: 'none', '&:hover': { color: 'primary.main' } }}
                >
                  Forgot password?
                </Box>
              </Box>
              ...
              <Button
                ...
                fullWidth
                disabled={isLoading}
                endIcon={isLoading ? <CircularProgress size={18} color="inherit" /> : <LoginIcon />}
                sx={{ py: 1.5, mt: 0.5 }}
              >
